...
export function VendorSelectionForm({ onNext, onBack }: { onNext: (data: any) => void; onBack: () => void }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="step-container">
      <div>
        <h2 className="step-title">Select Vendors</h2>
        <p className="step-description">
          Choose the vendors you want to send this RFx to
        </p>
      </div>
